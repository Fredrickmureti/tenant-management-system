...
-- Recreate current_balance using the corrected bill_amount
ALTER TABLE billing_cycles ADD COLUMN current_balance NUMERIC GENERATED ALWAYS AS (bill_amount - paid_amount) STORED;