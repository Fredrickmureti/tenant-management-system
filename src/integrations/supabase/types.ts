...
export type Database = {
  ...
  public: {
    Tables: {
      ...
      billing_cycles: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "fk_billing_cycles_tenant"
            columns: ["tenant_id"]
            isOneToOne: false
            referencedRelation: "tenants"
            referencedColumns: ["id"]
      ...
      communication_logs: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "fk_communication_logs_sent_by"
            columns: ["sent_by"]
            isOneToOne: false
          ...
          {
            foreignKeyName: "fk_communication_logs_tenant"
            columns: ["tenant_id"]
            isOneToOne: false
            referencedRelation: "tenants"
            referencedColumns: ["id"]
      ...
      payments: {
        ...
        Relationships: [
          {
            foreignKeyName: "fk_payments_billing_cycle"
          ...
          {
            foreignKeyName: "fk_payments_tenant"
            columns: ["tenant_id"]
            isOneToOne: false
            referencedRelation: "tenants"
            referencedColumns: ["id"]
    ...
    Enums: {
      user_role: "admin" | "clerk" | "tenant" | "superadmin"
    }
    CompositeTypes: {
      [_ in never]: never
    }
